...
import requests
import logging
from .semantic_chunker_v2 import LLMBackend


class OllamaBackendV2(LLMBackend):
    """
    ...
    def _verify_connection(self):
        ...
        try:
            ...
            if self.model not in model_names:
                ...
                self.logger.info(f"✓ Ollama backend v2 initialized with model '{self.model}'")
...
class OpenAIBackendV2(LLMBackend):
    ...
    def score_boundary(
        ...
        messages = [
            {
                "role": "system",
                "content": OllamaBackendV2.SYSTEM_PROMPT
            },
            {
                "role": "user",
